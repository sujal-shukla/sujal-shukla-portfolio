...
interface ProjectDocumentData {
  ...
  /**
   * View Project field in *Project*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project.view_project
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  view_project: prismic.LinkField;
...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * Button LIink field in *Biography → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.button_liink
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_liink: prismic.LinkField;
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Fall Back Image field in *ContentIndex → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.primary.fall_back_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
